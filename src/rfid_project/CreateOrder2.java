 ...
 * @author LENOVO
 */
public class CreateOrder2 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(101, 274, Short.MAX_VALUE))
            .addGroup(layout.createSequentialGroup()
                .addGap(83, 83, 83)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        for(int i=0;i<prods.size();i++){
            ...
            o.setPrice(prods.get(i).getPrice());
            o.setProductID(prods.get(i).getPid());
            o.setQuantity(prods.get(i).getQuantity());
            total += prods.get(i).getPrice()*prods.get(i).getQuantity();
            o.setTotalItem(prods.get(i).getPrice()*prods.get(i).getQuantity());
            orrr.add(o);
        }
        System.out.println("orr"+orrr.size());
        or.setTotal(total);
        or.setStatus(1);
           ...
           if( jTextField1.getText  ().equals("")){
               JOptionPane.showMessageDialog(this, "Please Enter a quantity");
                ...
                listModel1.addElement(jComboBox1.getSelectedItem());
                    ...
                    prods.add(products.get(jComboBox1.getSelectedIndex()));
